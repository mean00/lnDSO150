...
#define msg_set_trigger_value_init_default       {0}
...
#define msg_set_trigger_value_init_zero          {0}
...
#define msg_set_trigger_value_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, FLOAT,    trigger_value,     1)
