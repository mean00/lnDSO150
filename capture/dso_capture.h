...
class DSOCapture
{
  public:
    ...
    enum DSO_TIME_BASE
    {
        ...
        // DSO_TIME_BASE_500MS,
        // DSO_TIME_BASE_1S,
        DSO_TIME_BASE_MAX = DSO_TIME_BASE_50MS
    };
  ...
  public:
    ...
    static void setCouplingMode(int isAc)
    {
        _couplingModeIsAC = isAc;
    }
    ...
    static DSOCapture::captureState state()
    {
        return _state;
    };
